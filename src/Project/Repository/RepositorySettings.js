          ...
          <Tab.Pane>
            ...
            <Form>
              {!projectInfo.ssh_key_id ? (
                ...
                <Message>
                  Ssh already uploaded, to reset press the button below
                </Message>
              )}
            </Form>
            <br />
        ...
        render: () => (
            <Tab.Pane>
              ...
              {gitTags !== [] ? (
                  ...
                  this.props.match.params.project_name +
                  "/repositories/" +
                          this.props.match.params.repository_name + '/tags/'+ tag.value + '/tree' }>{tag.value}</a>
