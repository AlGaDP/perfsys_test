            ...
            <Grid.Column width={9}>
              ...
              <Grid.Column width={12}>
                ...
                <Segment secondary>
                  ...
                  <Label size='normal' id="label-branchinside">{item.sourceBranch}</Label><Icon name="angle double right"
                                                                                        size='small'/><Label
                    size='normal' id="label-branchinside">{item.destinationBranch}</Label>
