...
class EditFilePull extends React.Component {
  ...
  getData() {
    ...
    const regexpPath =
        /\/projects\/[A-Za-z-\d_-]{1,33}\/repositories\/[A-Za-z-\d_-]{1,33}\/compare\/commits\/[A-Za-z-\d_-]{1,100}\/[A-Za-z-\d_-]{1,100}\/(.{0,1000})/;
    Promise.all([fetch(
            ...
            <Segment secondary>
              <Grid>
                <Grid.Column width={13}>
                  <Header as="h3">{commit1.message.substr(0, 200)}</Header>
                            ...
                            <Menu.Menu color="blue" position="left">
                              <Menu.Item color="blue">
                                <Header as="h5">
                                  ...
                                  <Header.Subheader>{items2.fileSize} bytes</Header.Subheader>
              ...
              <Menu.Menu color="blue" position="left">
                <Menu.Item color="blue">
                  <Header as="h5">
                    ...
                    <Header.Subheader>{items1.fileSize} bytes</Header.Subheader>
                  </Header>
                </Menu.Item>
                <Label>After</Label>
              </Menu.Menu>
